...
class StandaloneEqualizerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final EqualizerController controller =
        Get.put(EqualizerController(), tag: 'standalone_equalizer');
                        ...
                        Container(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              ...
                              Get.delete<EqualizerController>(
                                  tag: 'standalone_equalizer');
                              Get.back();
                            },
                          ),
                        ),
                      ...
                      children: [
                        ...
                        Obx(() => Wrap(
                              ...
                              children: controller
                                  ...
                                  .map((preset) {
                                final isSelected =
                                    controller.currentPreset.value == preset;
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(
                          height: screenHeight *
                              0.2, // Smaller height to prevent overflow
                          child: Obx(() => Row(
                                mainAxisAlignment:
                                ...
                                children: List.generate(
                                  ...
                                  (index) => _buildEnhancedFrequencyBand(
                                    ...
                                    index,
                                    screenHeight *
                                        0.15, // Much smaller height to fit
                                    context,
                                  ),
                                ),
                              )),
